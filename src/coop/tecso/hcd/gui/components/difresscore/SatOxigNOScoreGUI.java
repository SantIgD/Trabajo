...
public class SatOxigNOScoreGUI extends GenericScoreGUI {

    // MARK: - Init

    public SatOxigNOScoreGUI(Context context, boolean enabled) {
        super(context, enabled);
    }

    @Override
    protected Cursor getCamposCursor(SQLHelper sqlHelper) {
        Integer scoreType = DifRespHelper.scoreDifResSatOxNoTipo();
    ...
    public boolean shouldDisplaySection() {
        ...
        return Helper.compareBoolean(insufRespSelectedOption, false);
    }
