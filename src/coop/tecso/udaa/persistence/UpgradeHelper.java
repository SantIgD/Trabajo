...
public final class UpgradeHelper {
	...
	private static final Set<Integer> VERSION;
	 ...
	 */
	static void addUpgrade(final int version) {
	 ...
	 */
	static List<String> availableInserts(Resources resources) {
	 ...
	 * 
	 * @param resources the {@link Resources} from the given {@link Context} which maybe using the helper class
	 * @Param fileName DDL files must be kept in assets/inserts/xxx.sql
	 * @return A list of SQL statements which have been included in the
	 */
	static List<String> availableInserts(Resources resources, final String fileName) {
		final List<String> inserts = new ArrayList<String>();
	 ...
	 * @return A list of SQL statements which have been included in the
	 */
	static List<String> availableUpdates(Resources resources) {
	...
	static boolean canUpgrade(Class<?> clazz){
	 ...
	 */
	private static String loadAssetFile(Resources resources, String fileName) {
		try {
