...
public class ScoreECGGUI extends CampoGUI {
    ...
    private List<TextView> textViewTitulos;
    ...
    private boolean validateAllGroupsSelected() {
        ...
        for (String grupo: mapGrupoListCheckBox.keySet()) {
            checkboxes = mapGrupoListCheckBox.get(grupo);
            boolean isGroupSelected = isGroupSelected(checkboxes);
            final TextView textView = grupoTextView.get(grupo);
            if (!isGroupSelected) {
    ...
    public boolean validate() {
        ...
        if (isUserSucursalRosario) {
            if (idValorSeleccionadoCmbECGInterpretado == idValorNoCmbECGInterpretado) {
                valid = this.validateAllGroupsSelected();
            } else if (!CollectionUtils.isEmpty(textViewTitulos)) {
                for (TextView textView: textViewTitulos) {
